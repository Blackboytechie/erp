...
export default function InvoicePaymentModal({ isOpen, onClose, invoice, onPaymentSaved }: InvoicePaymentModalProps) {
  const [formData, setFormData] = useState({
    amount: invoice.net_amount - (invoice.paid_amount || 0),
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg mb-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="text-gray-900 font-medium">₹{invoice.net_amount.toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-500">Previously Paid:</span>
                            <span className="text-green-600 font-medium">₹{(invoice.paid_amount || 0).toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-500">Remaining Balance:</span>
                            <span className="text-red-600 font-medium">₹{(invoice.net_amount - (invoice.paid_amount || 0)).toLocaleString()}</span>
                          </div>
                          {formData.amount > 0 && (
                            <>
                              ...
                              <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium">{(invoice.net_amount - (invoice.paid_amount || 0) - formData.amount).toLocaleString()}</span>
                              </div>
                            </>
                          )}
                        </div>
                          ...
                          <div className="sm:col-span-3">
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                              ...
                              <input
                                ...
                                min="0.01"
                                step="0.01"
                                max={invoice.net_amount - (invoice.paid_amount || 0)}
